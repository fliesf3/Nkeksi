            ...
            public void onFailure(@NonNull Exception e) {
                auth.fetchProvidersForEmail(email).addOnSuccessListener(new OnSuccessListener<ProviderQueryResult>() {
                    ...
                    public void onSuccess(ProviderQueryResult providerQueryResult) {
                        progressDialog.dismiss();
                        Toast.makeText(RegisterUser.this, "Email already Exist", Toast.LENGTH_SHORT).show();
                        return;
                    }
                });
                Toast.makeText(RegisterUser.this, "Failed Check Network "+e, Toast.LENGTH_SHORT).show();
            }
        });
